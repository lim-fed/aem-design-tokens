...
MapTo("wknd-spa-react/components/download")(DownloadV1, {
  isEmpty: DownloadV1IsEmptyFn,
});
MapTo("wknd-spa-react/components/list")(ListV2, { isEmpty: ListV2IsEmptyFn });
MapTo("wknd-spa-react/components/separator")(SeparatorV1, {
  isEmpty: SeparatorV1IsEmptyFn,
});

MapTo("wknd-spa-react/components/button")(ButtonV1, {
  isEmpty: ButtonV1IsEmptyFn,
});
MapTo("wknd-spa-react/components/teaser")(TeaserV1, {
  isEmpty: TeaserV1IsEmptyFn,
});
MapTo("wknd-spa-react/components/image")(ImageV2, {
  isEmpty: ImageV2IsEmptyFn,
});
MapTo("wknd-spa-react/components/title")(TitleV2, {
  isEmpty: TitleV2IsEmptyFn,
});

MapTo("wknd-spa-react/components/breadcrumb")(BreadCrumbV2, {
...
MapTo("wknd-spa-react/components/accordion")(AccordionV1, {
  isEmpty: AccordionV1IsEmptyFn,
});
MapTo("wknd-spa-react/components/carousel")(CarouselV1, {
  isEmpty: CarouselV1IsEmptyFn,
});
MapTo("wknd-spa-react/components/container")(ContainerV1, {
